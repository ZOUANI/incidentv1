...
public class EntiteAdministrative implements Serializable {
    ...
    @ManyToOne
    private EntiteAdministrative entiteAdministrativeSuperieure;
    ...
    public EntiteAdministrative getEntiteAdministrativeSuperieure() {
        return entiteAdministrativeSuperieure;
    }

    public void setEntiteAdministrativeSuperieure(EntiteAdministrative entiteAdministrativeSuperieure) {
        this.entiteAdministrativeSuperieure = entiteAdministrativeSuperieure;
    }
